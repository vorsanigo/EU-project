...
path <- '../Networks EFTA countries/sub edgelist without self-loops/'
...
# save results
write.csv(zero_df_int_norm, file='../Analysis/integration segregation/integration_time_nromalized.csv')
write.csv(zero_df_int, file='../Analysis/integration segregation/integration_time.csv')
write.csv(zero_df_segr, file='../Analysis/integration segregation/segregation_time.csv')