...
if (mst_type == 'window tot') or (mst_type == 'window country'):
    if red_emb_type == 'umap':
        output_dir = 'min spanning tree CORRECT/knn norm' + str(time_window) + ' year_months step ' + str(step) + ' window/' + str(components) + ' umap/'
    elif red_emb_type == 'pca':
        output_dir = 'min spanning tree CORRECT/knn norm' + str(time_window) + ' year_months step ' + str(step) + ' window/' + str(components) + ' PCA/'
    elif red_emb_type == 'no_red_emb':
        output_dir = 'min spanning tree CORRECT/knn norm' + str(time_window) + ' year_months step ' + str(step) + ' window/tot emb/'
...
efta_df = pl.read_csv('useful stuff/efta countries.csv')
